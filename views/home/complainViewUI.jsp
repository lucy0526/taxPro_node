		...
		<div class="vp_d_1">
			...
			<div class="vp_d_1_1">
				<div class="content_info">
					...
					<div class="tableH2">
						投诉详细信息
						<span style="color: red;">(<s:property value="#complainStateMap[comp.state]"/>)</span>
					</div>
					<table id="baseInfo" width="100%" align="center" class="list"
						...
						<tr>
							...
							<!-- 不专一标签等特殊内容：escape="false" -->
							<td>
								<s:property value="comp.compContent" escape="false" />
							</td>
						</tr>
						<tr>
							<td colspan="2" align="center">
