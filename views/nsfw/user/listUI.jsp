...
<head>
    ...
    <script type="text/javascript">
		...
		function doDeleteAll(){
			document.forms[0].action = "${basePath}nsfw/user_deleteSeleted.action";
			document.forms[0].submit();
		}
...
<form name="form1" action="${basePath}nsfw/user_listUI.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
